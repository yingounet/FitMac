...
struct FitMacCLI: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        discussion: """
            ...
            """,
        subcommands: [StatusCommand.self, CacheCommand.self, TrashCommand.self, LanguageCommand.self, SystemJunkCommand.self, SystemAppCommand.self, iTunesCommand.self, MailCommand.self, DuplicatesCommand.self, HomebrewCommand.self, LoginItemsCommand.self, LargeCommand.self, UninstallCommand.self, LogCommand.self],
