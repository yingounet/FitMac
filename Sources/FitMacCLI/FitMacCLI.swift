...
struct FitMacCLI: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        discussion: """
            ...
            """,
        subcommands: [StatusCommand.self, CacheCommand.self, TrashCommand.self, LanguageCommand.self, SystemJunkCommand.self, iTunesCommand.self, MailCommand.self, LargeCommand.self, UninstallCommand.self, LogCommand.self],
