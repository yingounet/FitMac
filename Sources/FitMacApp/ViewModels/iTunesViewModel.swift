...
@MainActor
final class iTunesViewModel: ObservableObject {
    @Published var scanResult: iTunesJunkScanResult?
    ...
    private let scanner = iTunesScanner()
    private let cleaner = iTunesJunkCleaner()
